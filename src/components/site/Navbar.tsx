        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Button variant="glass" size="sm" asChild>
              <a href="#recruitment">Apply Now</a>
            </Button>
            <Button variant="hero" size="sm" asChild>
              <a href="#pricing">Start Training</a>
            </Button>
          </div>
        ...
        {open && (
          <div className="lg:hidden mt-2 glass-strong rounded-2xl p-4 animate-fade-in">
              ...
              {links.map((l) => (
                <li key={l.href}>
                  <a
                    ...
                    className="block px-3 py-2 rounded-lg text-sm font-medium text-muted-foreground hover:bg-secondary hover:text-gold"
                  >
                    {l.label}
                  </a>
                </li>
            ...
            <div className="grid grid-cols-2 gap-2 mt-3">
              <Button variant="glass" size="sm" asChild>
                <a href="#recruitment">Apply</a>
              </Button>
              <Button variant="hero" size="sm" asChild>
                <a href="#pricing">Train</a>
              </Button>
            </div>
          </div>
        )}
